...
#Getting Started
   ...
   3. Download, install, and start a local web server (eg. [XAMPP](http://www.apachefriends.org/en/xampp.html).  Make sure to put this repository in your local server's public folder (eg. htdocs)
