//  UserView.js
define(['jquery', 'backbone',"text",'models/UserModel','text!templates/tableRows.html'],
        function($, Backbone, Text, UserModel, template){
    ...
    var View = Backbone.View.extend({
        ...
        setViewTemplate: function() {
            ...
            this.template = _.template( template, { users: this.collection } );
        }
    });
